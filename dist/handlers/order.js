...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var shownOrder, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderStore.show(parseInt(req.params.id))];
            case 1:
                shownOrder = _a.sent();
                res.json(shownOrder);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, orderStore.create(newOrder)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, productId, quantity, productAdded, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, orderStore.addProduct(orderId, productId, quantity)];
            case 1:
...
var orders_routes = function (app) {
    ...
    app.post("/orders/:id/products", jwtValidator_1["default"], addProduct);
};
